...
//				PassValues.setBookCartPublicationYear(Publication_year.get(index));//BAHAAAAAAAAAA*= ************************
...
//			grid.add(new Label("Publication year:"), 0, 3);                       //BAhAA ****************************************************************
//			grid.add(new Label(Publication_year.get(index).toString()), 1, 3);	//BAHAA
