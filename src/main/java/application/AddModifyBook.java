...
public class AddModifyBook extends Pane {
	...
	@FXML
	private Label CategoryLabel , TitleLabel , PriceLabel ,PublisherLabel , ThersholdLabel ,AuthorsLabel ;
	...
	@FXML
	Button add ,getdata,modify;


	@FXML
	private Label Cplabel, QuantityLabel , copies , orderQ;
